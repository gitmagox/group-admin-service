...
trait ModelTree
{
    ...
    public function toTreeByList($list)
    {
        return $this->buildNestedArrayl($list);
    }
     ...
     * @return array
     */
    protected function buildNestedArrayl(array $nodes = [], $parentId = 0)
    {
        $branch = [];
        ...
        foreach ($nodes as $node) {
            ...
            if ($node['parent_id'] == $parentId) {
                ...
                $children = $this->buildNestedArrayl($nodes, $node['id']);
                if ($children) {
